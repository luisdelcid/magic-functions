 ...
 * @return void
 */
function __enqueue_fa6($preferred_version = '6.4.2'){
	__set_cache('enqueue_fa6', $preferred_version);
	__add_action_once('wp_enqueue_scripts', '__maybe_enqueue_fa6');
}
...
function __enqueue_inputmask($preferred_version = '5.0.8'){
	...
	__add_action_once('wp_enqueue_scripts', '__maybe_enqueue_inputmask');
}
...
function __enqueue_stylesheet(){
	...
	__add_action_once('wp_enqueue_scripts', '__maybe_enqueue_stylesheet');
}
 ...
 * @return void
 */
function __maybe_enqueue_inputmask(){
 ...
 * @return void
 */
function __maybe_enqueue_stylesheet(){
