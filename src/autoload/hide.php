...
function __maybe_hide_others_posts_count(){
    ...
    $hide_others_posts_screens = (array) __get_cache('hide_others_posts_screens', []);
    if(in_array($current_screen->id, $hide_others_posts_screens)){
        return;
    }
    $hide_others_posts_screens[] = $current_screen->id;
    __set_cache('hide_others_posts_screens', $hide_others_posts_screens);
