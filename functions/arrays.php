 ...
 * @return bool
 */
function __is_array_assoc(...$args){
	return __is_associative_array(...$args); // Alias for __is_associative_array for backward compatibility.
}
 ...
 * @return array
 */
function __list_pluck($list = [], $index_key = ''){
	$newlist = [];
